...
export const products: Product[] = [
  // RINGS (8 products)
  {
    ...
    description: 'A stunning solitaire ring featuring a brilliant-cut diamond set in 18K gold.',
  ...
  },
  {
    ...
    longDescription: 'Inspired by the mystique of moonlit evenings, the Crescent Moon Ring features a delicate arc of pavé-set diamonds that trace the silhouette of a crescent moon. Set in 18K white gold, this celestial creation embodies the poetry of the night sky, making it an enchanting addition to any jewelry collection.',
    category: 'rings',
    price: 1680,
    rating: 4.8,
    reviewCount: 29,
  ...
  },
  {
    id: 'ring-005',
    name: 'Torsade Signet',
    description: 'A modern signet ring with a twisted rope motif around the bezel.',
    longDescription: 'The Torsade Signet reinterprets the classic signet ring for the modern wearer. A twisted rope motif frames a smooth oval bezel, blending heritage craft with contemporary sensibility. Cast in solid 18K gold and finished by hand, this statement ring carries a satisfying weight that speaks of quality.',
    category: 'rings',
    price: 1540,
    rating: 4.8,
    reviewCount: 22,
  ...
  },
  {
    ...
    description: 'An opulent cocktail ring with a floral cluster of colored gemstones.',
    longDescription: 'The Fleur Cocktail Ring is a celebration of color and craftsmanship. A cluster of hand-selected gemstones—tourmaline, peridot, and citrine—are arranged in a floral formation atop an 18K gold setting. This bold, show-stopping piece is designed for those who believe jewelry should spark conversation.',
    category: 'rings',
    price: 3200,
    originalPrice: 3800,
    rating: 5.0,
  ...
  },
  {
    id: 'ring-007',
    name: 'Infinity Twist',
    description: 'An intertwined double-band ring symbolizing eternal connection.',
    longDescription: 'Two slender bands of polished gold intertwine in an elegant figure-eight, symbolizing an unbreakable bond. The Infinity Twist ring is equally suited to mark a milestone moment or to serve as a daily reminder of love. Its streamlined profile sits close to the finger, ensuring comfort throughout the day.',
    category: 'rings',
    price: 960,
    rating: 4.7,
    reviewCount: 55,
  ...
  },
  {
    ...
    description: 'A lustrous South Sea pearl perched on a sculptural gold setting.',
    longDescription: 'A single South Sea pearl, selected for its exceptional luster and perfectly round shape, is cradled in a sculptural 18K gold setting. The Perle Solitaire elevates organic beauty through architectural design, creating a piece that feels both modern and timeless.',
    category: 'rings',
    price: 2100,
    rating: 4.9,
    reviewCount: 18,
  ...
  // NECKLACES (8 products)
  {
    ...
    longDescription: 'The Cascade Pendant features a series of delicately graduated gold droplets that fall in a graceful cascade from a fine chain. As you move, the droplets catch light independently, creating a shimmering waterfall effect against the skin. Crafted in 18K gold with a 42cm adjustable chain.',
    category: 'necklaces',
    price: 1850,
    rating: 4.9,
    reviewCount: 52,
  ...
  },
  {
    ...
    longDescription: 'The Lumière Choker strips jewelry to its purest essence: a single brilliant diamond appears to float at the hollow of the throat, suspended on an invisible nylon cord anchored by gold clasps. The effect is mesmerizing—a point of light that moves with you. Available in 0.25ct and 0.50ct diamond options.',
    category: 'necklaces',
    price: 2200,
    rating: 4.8,
    reviewCount: 38,
  ...
  },
  {
    ...
    longDescription: 'Our Héritage Locket reimagines the sentimental classic for a modern audience. The smooth 18K gold oval opens to reveal space for two photographs, while the exterior is adorned with hand-engraved botanical motifs by our master engravers. A piece meant to hold memories close to the heart.',
    category: 'necklaces',
    price: 1620,
    rating: 4.7,
    reviewCount: 27,
  ...
  },
  {
    ...
    longDescription: 'Like stars scattered across a midnight sky, tiny brilliant-cut diamonds are set at irregular intervals along a fine 18K gold chain. The Constellation Chain drapes beautifully at the collarbone and layers perfectly with other necklaces. Each piece features seven diamonds, one for each day of the week.',
    category: 'necklaces',
    price: 1950,
    rating: 4.9,
    reviewCount: 44,
  ...
  },
  {
    ...
    longDescription: 'The Serpentine Collar is an exercise in fluid metalwork. Inspired by the sinuous movement of a serpent, this 18K gold collar necklace hugs the neck with supple articulated links, creating a second-skin effect that is both bold and refined. A true collector\'s piece for the discerning wearer.',
    category: 'necklaces',
    price: 4500,
    originalPrice: 5200,
    rating: 5.0,
  ...
  },
  {
    ...
    longDescription: 'Our Rivière Pearl Strand features 45 individually knotted Akoya pearls, each selected for its exceptional luster, smooth surface, and rosy overtone. The 18K gold toggle clasp—stamped with the Luna Bijoux crescent—adds a modern finishing touch to this timeless silhouette.',
    category: 'necklaces',
    price: 3400,
    rating: 4.8,
    reviewCount: 33,
  ...
  },
  {
    ...
    longDescription: 'Pure geometry meets precious materials in this minimalist pendant. A slim bar of polished 14K gold hangs horizontally from a fine cable chain, creating a clean line that sits perfectly at the collarbone. Available for personalized engraving—add initials, a date, or a meaningful word.',
    category: 'necklaces',
    price: 680,
    rating: 4.6,
    reviewCount: 71,
  ...
  // BRACELETS (7 products)
  {
    ...
    longDescription: 'The Chaîne d\'Or makes an unapologetic statement on the wrist. Oversized oval links are cast in solid 18K gold and finished with a contemporary matte texture that sets it apart from traditional polished chains. The substantial weight and smooth edges ensure comfort despite its bold proportions.',
    category: 'bracelets',
    price: 2800,
    rating: 4.9,
    reviewCount: 25,
  ...
  },
  {
    ...
    longDescription: 'The Fil d\'Or Bangle is the epitome of understated luxury. A single wire of 14K gold is gently twisted along its circumference, creating subtle texture that catches light with every gesture. Designed to be stacked in multiples or worn alone as a whisper of elegance.',
    category: 'bracelets',
    price: 720,
    rating: 4.7,
    reviewCount: 58,
  ...
  },
  {
    ...
    longDescription: 'The Jardin Cuff transforms the wrist into a canvas for wearable art. Intricate botanical reliefs—leaves, vines, and blossoms—are sculpted into the surface of a wide 18K gold cuff. Despite its ornate design, the interior is smooth and comfortable, and the open-back construction allows easy on and off.',
    category: 'bracelets',
    price: 3600,
    originalPrice: 4200,
    rating: 5.0,
  ...
  },
  {
    ...
    longDescription: 'Our Tennis Classique features a continuous line of 38 individually set round brilliant diamonds, totaling 3.2 carats. Each stone is hand-selected for exceptional color and clarity, then secured in a four-prong 18K white gold setting. The hidden safety clasp ensures peace of mind for daily wear.',
    category: 'bracelets',
    price: 5800,
    rating: 4.9,
    reviewCount: 19,
  ...
  },
  {
    ...
    longDescription: 'The Médaillon Charm Bracelet invites you to curate your own story. A robust 14K gold cable chain supports three detachable medallion charms, each engraved with a different Luna Bijoux motif. Additional charms are available separately, allowing your bracelet to evolve with you over time.',
    category: 'bracelets',
    price: 1350,
    rating: 4.6,
    reviewCount: 34,
  ...
  // EARRINGS (7 products)
  {
    ...
    longDescription: 'The Goutte d\'Or Drops are a study in graceful simplicity. Each earring features a single teardrop of solid 18K gold with a soft brushed finish that gives the metal a warm, satiny glow. The lightweight construction ensures all-day comfort, while the silhouette elongates the face beautifully.',
    category: 'earrings',
    price: 1240,
    rating: 4.8,
    reviewCount: 46,
  ...
  },
  {
    ...
    longDescription: 'Our Étoile Studs are the jewelry equivalent of a whispered secret. Tiny five-pointed stars, each just 6mm across, are set with a single brilliant-cut diamond at the center. Crafted in 18K gold with secure butterfly backs, these studs add a touch of celestial charm to any outfit.',
    category: 'earrings',
    price: 780,
    rating: 4.9,
    reviewCount: 73,
  ...
  },
  {
    ...
    longDescription: 'Our Orbit Hoops challenge the conventional round hoop with a subtly squared silhouette that feels fresh and architectural. Crafted in 14K gold with a high-polish finish, these 30mm hoops feature a secure click-shut closure. A modern essential for every jewelry wardrobe.',
    category: 'earrings',
    price: 650,
    rating: 4.8,
    reviewCount: 67,
  ...
  },
  {
    ...
    longDescription: 'Celebrating the beauty of irregularity, the Perle Baroque Drops feature hand-selected baroque pearls suspended from sculptural 18K gold hooks. No two pearls are alike, ensuring that each pair of earrings is truly one of a kind. The hooks are designed to sit comfortably and securely in the ear.',
    category: 'earrings',
    price: 1580,
    rating: 4.9,
    reviewCount: 31,
  ...
  },
  {
    ...
    longDescription: 'The Thread Earrings are the essence of barely-there beauty. An ultra-fine chain threads through the ear, leaving a gentle drape in front and a longer flowing tail behind. Crafted in 14K gold, they move with every turn of the head, creating an almost liquid effect that is endlessly captivating.',
    category: 'earrings',
    price: 420,
    rating: 4.6,
    reviewCount: 54,
...
export const reviews: Review[] = [
  { id: 'rev-1', productId: 'ring-001', author: 'Isabelle M.', rating: 5, date: '2025-12-15', title: 'Absolutely breathtaking', content: 'This ring exceeded every expectation. The diamond catches light beautifully and the gold has a warm, rich tone. I receive compliments every time I wear it.', verified: true },
  { id: 'rev-2', productId: 'ring-001', author: 'Charlotte D.', rating: 5, date: '2025-11-22', title: 'Worth every penny', content: 'My partner surprised me with this ring for our anniversary. The craftsmanship is impeccable—you can tell it is handmade with care. The packaging was also gorgeous.', verified: true },
  { id: 'rev-3', productId: 'ring-001', author: 'Sophia L.', rating: 4, date: '2025-10-30', title: 'Beautiful but runs slightly small', content: 'The ring itself is stunning—true luxury. I would recommend sizing up half a size as it runs a touch small. Customer service was very helpful with the exchange.', verified: true },
  { id: 'rev-4', productId: 'necklace-001', author: 'Elena R.', rating: 5, date: '2025-12-01', title: 'My new everyday necklace', content: 'I have not taken this off since I received it. The cascading droplets are so delicate and catch light beautifully. Transitions perfectly from work to evening.', verified: true },
  { id: 'rev-5', productId: 'necklace-001', author: 'Amara T.', rating: 5, date: '2025-11-15', title: 'Perfect gift', content: 'Purchased this for my mother birthday and she was thrilled. The presentation, the quality, and the design—everything screams luxury. Will be ordering more from Luna Bijoux.', verified: true },
  { id: 'rev-6', productId: 'bracelet-001', author: 'Victoria S.', rating: 5, date: '2025-12-10', title: 'Statement piece perfection', content: 'This bracelet is substantial without being heavy. The matte finish is gorgeous and unique—I have never seen anything like it. Makes every outfit look more intentional.', verified: true },
  { id: 'rev-7', productId: 'earring-001', author: 'Margaux B.', rating: 5, date: '2025-11-28', title: 'Lightweight luxury', content: 'These drops are incredibly comfortable for all-day wear. The brushed gold finish gives them a soft, warm glow that is different from typical shiny jewelry. Truly elegant.', verified: true },
  { id: 'rev-8', productId: 'earring-002', author: 'Léa F.', rating: 5, date: '2025-12-05', title: 'Dainty and perfect', content: 'These studs are exactly what I was looking for—small but impactful. The diamond catches light even though it is tiny. Perfect for someone who prefers subtle jewelry.', verified: true },
];
